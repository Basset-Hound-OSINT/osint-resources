# Reverse Engineering Tools List
## Free & Open Source Tools for Linux & Cross-Platform
...
- [**ILSpy**](https://github.com/icsharpcode/ilspy) - .NET decompiler (cross-platform via AvaloniaILSpy)
...
- [**TrID**](https://mark0.net/download/trid.zip) - File identifier
...
- [**ktool**](https://github.com/0cyn/ktool) - MachO/ObjC Analysis + Editing toolkit.
...
6. **Radare2/Cutter** - Command-line alternative to Ghidra

**Platform-Specific Additions:**
- **Android**: Jadx, Apktool, MobSF, objection
- **iOS**: class-dump, objection, Frida
- **.NET**: ILSpy (cross-platform via AvaloniaILSpy)
- **Java**: CFR, Jadx
- **Python**: uncompyle6
...
- **Ghidra** is prioritized as the primary cross-platform disassembler
- **Radare2** provides command-line alternative for terminal workflows
- **Frida** is cross-platform and works on Windows, Linux, macOS, Android, and iOS
- **ILSpy** is cross-platform via AvaloniaILSpy for Linux, macOS, and Windows
...
- For Windows-specific tools (x64dbg, dnSpy, Sysinternals, etc.), see tools_windows.md
