...
- [DoNotPay](https://donotpay.com/learn/temporary-phone-number/) - Use a Temporary Phone Number To Protect Your Privacy
...
- [Kasm](https://kasmweb.com/) - Disposable Secure Browser or Desktop
...
- [Dotspotter](https://www.forensicdots.de/) - Discover the tracking dots on a scanned document. Upload an image (600 dpi) of your print out. Dottspotter will try to detect the yellow dot code (MIC). See below for details. Results will be shown on this page.
...
- [DeepL](https://www.deepl.com/translator) - DeepL trains artificial intelligence to understand and translate texts.
- [Project CSV](https://projectcsv.github.io/) - Online & Offline CSV File Viewer & Editor
- [CSV to HTML](https://codepen.io/RYJASM/pen/LVEWgV)
- [Monaco Editor](https://microsoft.github.io/monaco-editor/playground.html)
- [Online FlowChart Editor](https://mermaid-js.github.io/mermaid-live-editor/) - Simplify documentation and avoid heavy tools. Open source Visio Alternative. Commonly used for explaining your code! Mermaid is a simple markdown-like script language for generating charts from tex...
...
- [Frack](https://github.com/sensepost/Frack) - Frack is my attempt at creating an end-to-end solution to store, manage and query your breach data. The tool has got a very basic workflow making it easy to use.
- [pywhat](https://pypi.org/project/pywhat/)
- [theHarvester](https://pypi.org/project/theHarvester/) - theHarvester is a very simple, yet effective tool designed to be used in the early stages of a penetration test. Use it for open source intelligence gathering and helping to determine a company's external threat landscape on the internet
...
- [Maltego](https://www.maltego.com/) - Graph link-analysis platform with community transforms covering people, infrastructure, and breaches.
- [SpiderFoot](https://www.spiderfoot.net/) - Automated OSINT collection framework with 200+ data sources and flexible scanning profiles.
- [Recon-ng](https://github.com/lanmaster53/recon-ng) - Metasploit-style reconnaissance environment with modular data gathering and reporting.
...
- [Privacy Services by Michael Bazzell](https://inteltechniques.com/workbook.html) - This is the third step of a three-step process to request, freeze, and remove your personal information from within data broker and credit reporting services.
...
- [PRISM Break](https://prism-break.org/en/) - Opt out of global data surveillance programs like PRISM, XKeyscore and Tempora. Help make mass surveillance of entire populations uneconomical! We all have a right to privacy, which you can exercis...
...
- [Meteostat](https://meteostat.net/) - Free historical weather and climate data with CSV/JSON export and a Python client.
- [Zoom.Earth](https://zoom.earth/) - Live weather radar and satellite imagery with storm tracking and wildfire overlays.
...
- [OpenCTI](https://www.opencti.io/) - Open-source threat intelligence platform with graph analytics and connectors to dozens of data feeds.
- [MISP](https://www.misp-project.org/) - Open-source threat intelligence sharing platform (STIX/TAXII) for indicators, events, and collaborative analysis.
...
- [Vedbex DNS Resolver](https://www.vedbex.com/) - Web-based DNS resolver tool for looking up A, AAAA, CNAME, MX, TXT, NS, PTR, and other DNS records
...
- [LinkScope](https://github.com/AccentuSoft/LinkScope_Client) - Repository for the LinkScope Client software
...
- [LittleBrother](https://github.com/lulz3xploit/LittleBrother) - Open-source investigator focusing on French data sources with geocoding and people search modules.
...
- [OSINT Toolkit](https://one-plus.github.io/EmailUsername) - In order to use these tools, please enter the username into the relevant box below, excluding any prefixed @ or # symbols. N.B. any results for usernames are an approximation, as such, any negative results, especially in the case of searches relating to messaging apps (Kik, Snapchat, Whatsapp, etc), does not necessarily mean the username is not in use.
- [Username search tool](https://www.aware-online.com/en/osint-tools/username-search-tool/)
- [snoop](https://github.com/snooppr/snoop)
- [quidam](https://pypi.org/project/quidam/) - Quidam allows you to retrieve information thanks to the forgotten password function of some sites.
...
- [Infoga](http://github.com/m4ll0k/Infoga) - Infoga - Email OSINT. Contribute to m4ll0k/Infoga development by creating an account on GitHub.
...
- [h8mail](https://pypi.org/project/h8mail/) - Email OSINT and password breach hunting. Use h8mail to find passwords through different breach and reconnaissance services, or the infamous Breached Compilation torrent
...
- [collector](https://github.com/galihap76/collector) - Collector is a tool OSINT (open source intelligence) and information gathering.
...
- [Skype Search Engine](https://www.skypli.com/) - Skype Search Engine
...
- [Blackbird](https://github.com/p1ngul1n0/blackbird) - CLI toolkit to enumerate social media profiles by username across dozens of platforms.
- [Social Analyzer](https://github.com/qeeqbox/social-analyzer) - Web app and CLI for cross-platform username checks with rich profile parsing.
...
- [teddit](https://teddit.net/) - Reddit privacy frontend
- [Reddit Search](https://camas.unddit.com/) - Search reddit using the pushshift.io API. For more advanced searches you can directly query the API fairly easily.
- [Karma Decay](http://karmadecay.com/)
- [redditsfinder](https://pypi.org/project/redditsfinder/) - A command line program to easily download reddit users' post histories.
...
- [Chearch](https://adhesivecheese.github.io/chearch/) - Pushshift Frontend
- [NY Dolls.org](https://nydolls.org/author) - USE: https://nydolls.org/author/REDDITOR
...
- [nqntnqnqmb](https://pypi.org/project/nqntnqnqmb/) - Allows you to retrieve information on linkedin profiles, companies on linkedin and search on linkedin companies/persons
...
- [Twitch Tools](https://twitch-tools.rootonline.de/) - View the follower list of any Twitch channel
...
- [toutatis](https://pypi.org/project/toutatis/) - It is a tool written to retrieve private information such as Phone Number, Mail Address, ID on Instagram accounts via API.
...
- [Telegago](https://cse.google.com/cse?&cx=006368593537057042503:efxu7xprihg#gsc.tab=0) - Telegram Search Engine
...
- [Nekogram X](https://f-droid.org/packages/nekox.messenger/) - The third-party Telegram android app
...
- [TootFinder](https://tootfinder.ch/) - Indexed search for Mastodon toots, including posts older than the standard six-month retention.
- [Fediverse Observer](https://fediverse.observer/) - Discovery and analytics platform tracking Mastodon and ActivityPub instances, growth, and moderation.
...
- [SteamID.uk](https://steamid.uk/) - Lookup vanity URLs, account bans, VAC history, and related identifiers for Steam profiles.
- [SteamRep](https://steamrep.com/) - Community reputation database highlighting reported scammers and suspicious Steam accounts.
...
- [Botometer by OSoMe](https://botometer.osome.iu.edu/) - Botometer® (formerly BotOrNot) checks the activity of         Twitter accounts and gives them a score based on how likely they are to         be bots. Higher scores are more bot-like. Brought to yo...
...
- [Talkwalker](https://www.talkwalker.com/alerts) - Google Alerts alternative. The best and free alerts service with Twitter results
...
- [ExifTool](https://exiftool.org/) - Swiss-army metadata parser supporting EXIF, IPTC, XMP, and GPS tags for forensic workflows.
...
- [Global Fishing Watch](https://globalfishingwatch.org/map/) - Interactive map visualizing AIS data to expose fishing activity, transshipments, and port visits.
...
- [pagodo](https://github.com/opsdisk/pagodo) - automates Google searching for potentially vulnerable web pages and applications on the Internet.
...
- [OCCRP Aleph](https://aleph.occrp.org/) - Investigation dashboard indexing leaks, corporate records, sanctions, and PEP files from OCCRP and partners.
- [GDELT Project](https://www.gdeltproject.org/) - Global database capturing news events, tone, and imagery with downloadable datasets and live API endpoints.
...
- [Shodan](https://www.shodan.io/) - Search engine indexing internet-connected devices with powerful filters for exposed services.
...
- [dnstwist](https://github.com/dnstwist/dnstwist) - Domain permutation engine to spot typosquats, phishing hosts, and brand impersonations.
- [OWASP Amass](https://github.com/owasp-amass/amass) - In-depth attack surface mapping with extensive passive and active subdomain enumeration modules.
- [Sublist3r](https://github.com/aboul3la/Sublist3r) - Python-based subdomain enumerator leveraging public search engines and certificate transparency logs.
...
- [RadioReference](https://www.radioreference.com/apps/db/) - Scanner Frequencies and Radio Frequency Reference Database
...
- [awesome-maps-ukraine](https://github.com/Symbian9/awesome-maps-ukraine) - A curated list of maps of Ukraine, ukrainian mappers and tools that they use or develop for creating and publish maps.
...
- [Sentinel Hub EO Browser](https://apps.sentinel-hub.com/eo-browser/) - Interactive interface for Sentinel, Landsat, and MODIS imagery with spectral indices and time series.
- [Google Earth Web](https://earth.google.com/web/) - 3D globe with timelapse, street imagery, and annotation tools for geospatial verification.
- [NASA Worldview](https://worldview.earthdata.nasa.gov/) - Interactive viewer for NASA EOSDIS imagery with 900+ layers and near real-time satellite data.
- [OpenAerialMap](https://openaerialmap.org/) - Community-driven catalog of drone and aerial imagery available for download and analysis.
...
- [SunCalc](https://www.suncalc.org/) - Visualize sun position and shadow projections to estimate timestamps or verify geolocations.
- [MapChecking](https://www.mapchecking.com/) - Estimate crowd sizes by drawing polygons and applying density presets over interactive maps.
...
- [Ahmia — Search Tor Hidden Services](https://ahmia.fi/) - Search Tor Hidden Services
...
- [Raklet](http://iwr4usy33opfclmbyemzbmnwwnmmqpqltezpac7fyqqkdv3mabtm6kqd.onion.pet/) - Accurately fast search engine
- [Dark.fail](https://dark.fail/) - Reliability tracker and directory of Tor hidden services with uptime history and mirrors.
...
- [DeHashed](https://dehashed.com/) - Have you been compromised? DeHashed provides free deep-web scans and protection against credential leaks. A modern personal asset search engine created for security analysts, journalists, security ...
...
- [INFORMNAPALM](https://informnapalm.org/db/russian-aggression/#lang=en&page=m_unit) - Database of Russian Aggression
- [gogettr](https://pypi.org/project/gogettr/)
- [GUTTR](https://github.com/VVX7/GUTTR) - GETTR API client library written in Python
...
- [San Francisco CopWatch Database](https://airtable.com/embed/shreS9yA6eWiJAmHZ/tbl0A1AfPBOaPNBhH?backgroundColor=blue) - How to use CopWatch SF Cops are listed below alphabetically by last name. You can filter or group officers in different ways. Click on the magnifying glass to search by cop name, date of incident, …
